...
import {StyleSheet, StatusBar, Modal, View, Dimensions,Text} from 'react-native';
  ...
  return (
    <>
      ...
      <MainWrapper style={[{justifyContent: 'space-between'}]}>
              ...
              <View style={styles.mapViewInput}>
                <GooglePlacesAutocomplete
                  ...
                  onPress={(data, details = null) => {
                    ...
                    AsyncStorage.setItem("setloaction",data.description);
                    console.log(
                      'DETAILS =====> ',
        ...
        <Wrapper>
          <Spacer height={sizes.baseMargin} />
          {param.data.flag == 'home' ? (
            <ButtonColored
              onPress={() => navigate(routes.client.home,{locationAdress:location})}
              // onPress={() => goBack()}
              text="Confirm Location"
            />
          ) : (
            <ButtonColored
              // onPress={() => navigate(routes.client.home,{location:location,flag:"Location"})}
              onPress={() =>
                navigate(routes.client.selectAddress, {serviceName: 'Nails',locationAdress:location})
              }
              // onPress={() => goBack()}
              text="Confirm Location"
            />
