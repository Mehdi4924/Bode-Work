...
import {appImages, colors, sizes, appStyles, appIcons} from '../../../themes';
...
class StylistProfile extends Component {
  ...
  async componentDidMount() {
    ...
    let services = await getData('services', item.Id);
    let today = moment().format('YYYY-MM-DD');
    let CompletedBookings = await getData('Bookings', item.Id);
    console.log(item);
        ...
        >
          {item.userImages.length > 0 ? (
            ...
            <View style={{width: '100%', alignItems: 'center'}}>
              <Text style={{color:'grey'}}>No images</Text>
            </View>
          )}
        </Wrapper>
      </Wrapper>
      ...
      <Wrapper>
        ...
        <Wrapper animation="fadeInRightBig">
          {item.reviews && item.reviews.length > 0 ? (
            ...
            <View style={{width: '100%', alignItems: 'center'}}>
              <Text style={{color:'grey'}}>No Reviews</Text>
            </View>
          )}
        </Wrapper>
      </Wrapper>
    ...
    return (
      <Wrapper>
        ...
        {services.length > 0 ? (
          ...
          <View style={{width: '100%', alignItems: 'center'}}>
            <Text  style={{color:'grey'}}>No Services</Text>
          </View>
        )}
      </Wrapper>
    );
  ...
  render() {
    ...
    const {detail, portfolio} = this.state;
    return (
      <MainWrapper>
