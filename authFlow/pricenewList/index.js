...
const PricenewList = props => {
  const { data } = props?.route?.params
  const [basecost, setbasecost] = useState(20);
  const [basecosttime, setbasecosttime] = useState(20);
        ...
        <ScrollView>
          ...
          <ButtonColored
            ...
            onPress={() => {
              ...
              props.navigation.navigate(routes.createService, { editdata: a, base_cast: basecost, base_time: basecosttime ,flag:'price'})
            }}
