        ...
        >
            ...
            <MainWrapper>
                <Wrapper
                    ...
                    style={{ flexDirection: 'row', paddingVertical: height(2), paddingHorizontal: width(5) }}
                >
                    <TouchableOpacity
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', marginLeft: width(4) }}>
                        <MediumTitle style={{ color: "#000" }}>Customer Support</MediumTitle>
                        <RegularText style={{ color: "#ccc" }}>Live</RegularText>
                    </View>
                </Wrapper>
                <FlatList
                    data={chatMessages}
